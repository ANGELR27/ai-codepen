...
export const JsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10 20v-6m0 0V4m0 6h4m-4 0H6" />
  </svg>
);
...
export const ClearIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
       <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75L14.25 12m0 0l2.25 2.25M14.25 12L12 14.25m-2.58 4.92l-6.375-6.375a1.125 1.125 0 010-1.59L9.42 4.83c.211-.211.498-.33.795-.33H19.5a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25h-9.284c-.297 0-.584-.119-.795-.33z" />
    </svg>
);
...
export const PreviewIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
       ...
       <path strokeLinecap="round" strokeLinejoin="round" d="M15.232 8.232l3.536 3.536m-2.036-5.036l2.5 2.5m-5.232 2.5l5 5m-5-5l2.5-2.5m2.5 2.5l-2.5 2.5" />
    </svg>
);
...
export const CollapseIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9L3.75 3.75M3.75 3.75h4.5m-4.5 0v4.5m11.25 6.75l5.25 5.25m0 0v-4.5m0 4.5h-4.5M9 15l-5.25 5.25m0 0h4.5m-4.5 0v-4.5m11.25-6.75l5.25-5.25m0 0h-4.5m4.5 0v4.5" />
    </svg>
);
